---
name: retro
description: Retrospective — analyze reviewer feedback from the last pipeline run, distill actionable rules into agent learnings files so agents improve over time
user-invocable: true
---
