---
name: ship
description: End-to-end development pipeline — PM spec → implement → QA → code review → merge → retrospective. Use when starting a new feature, fix, or any development work that should go through the full workflow.
argument-hint: <feature or task description>
allowed-tools: [Read, Edit, Write, Glob, Grep, Bash, Agent, WebFetch, WebSearch]
---
